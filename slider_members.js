...
function updateSlider() {
    ...
    //если не маленький экран, то выводим по 3 карточки
    let windowWidth = window.innerWidth;
    if (windowWidth >= 476) {

        //простой вариант со смЕной сразу трех картинок
    ...
    /* в этом варианте добавляем и уБираем по одной карточке
    индекс + 2 следующих (их определяем в массив, в котором в цикле убираем _hidden, добавляем _appearance), всем остальным убираем класс _appearance, добавляем _hidden
    */
    /*
    let showed = [];
